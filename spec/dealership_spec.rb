...
describe(Dealership) do
  ...
  describe('#name') do
    it("returns the name of the dealership") do
      test_dealership = Dealership.new("Good Used Cars")
      expect(test_dealership.name()).to(eq("Good Used Cars"))
    end
  end
  ...
  describe(".clear") do
    it("empties out all of the saved dealerships") do
      Dealership.new("Good Used Cars").save()
      Dealership.clear()
      expect(Dealership.all()).to(eq([]))
    end
  end
  ...
  describe(".find") do
    it("returns a dealership by its id number") do
      test_dealership = Dealership.new("Good Used Cars")
      test_dealership.save()
      test_dealership2 = Dealership.new("Not-so-Good Used Cars")
  ...
  describe('#add_vehicle') do
   it("adds a new vehicle to a dealership") do
     test_dealership = Dealership.new("Good Used Cars")
     test_vehicle = Vehicle.new("Mazda", "CRV", 2002)
